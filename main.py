...
def main():
    ...
    color_rectangles = {  # color : rectangle
        RED: pygame.Rect(0, 100, 225, 225),  # x, y, largo y ancho del rectangulo
...
# Displays the sequence of colors the player must
...
def draw_window(color_rectangles, level):
    ...
    # titulo
    color_game_text = MAIN_FONT.render("MEMORY MATRIX", True, BLACK)
   ...
   # muestra los 4 cuadraditos de colores
    for color, rect in color_rectangles.items():
